...
/**
 * Entity mapped 1:1 to the {@code spread_default} table. {@code brandCode} is
 * populated only by enriched (joined) read queries and is ignored on update.
 * One row per brand, seeded by migration - never created/deleted through the API.
 */
