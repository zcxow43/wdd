...
/**
 * The single extension point any approval-gated feature implements once to plug into the
 * generic audit module. {@link AuditService} holds a registry of these beans keyed by
 * {@link #entityType()} and never references any specific entity's classes.
 */
public interface AuditHandler {
     ...
     * Throws the entity's own not-found exception if {@code entityId} doesn't exist.
     */
