...
<img src="backend/1-brand.png" width="320" alt="品牌在全景圖中的位置">
...
<img src="backend/1-currency.png" width="320" alt="幣種在全景圖中的位置">
...
<img src="backend/1-currency-pair-definition.png" width="320" alt="幣種對定義在全景圖中的位置">
...
<img src="backend/1-currency-pair.png" width="320" alt="品牌幣種對在全景圖中的位置">
...
<img src="backend/1-spread.png" width="320" alt="點差設定在全景圖中的位置">
...
<img src="backend/1-exchange-rate.png" width="320" alt="匯率同步紀錄在全景圖中的位置">
...
詳細欄位、規則與 API 定義 → docs/backend/exchange-rate.md
...
| 章節 | 對應 backend 詳細文件 |
|---|---|
| 品牌 | docs/backend/brand.md |
| 幣種 | docs/backend/currency.md |
| 幣種對定義 | docs/backend/currency-pair-definition.md |
| 品牌幣種對 | docs/backend/currency-pair.md |
| 點差設定（預設點差／點差群組） | docs/backend/spread.md |
| 匯率同步紀錄 | docs/backend/exchange-rate.md |
| 審核請求（通用模組） | docs/backend/audit.md |
